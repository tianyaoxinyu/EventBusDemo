package kotlindemo.forwor.com.eventbusdemo.utils;
...
/**
 * Created by Myy on 2018/12/15 10:46
 */
public class SpanStringUtil {
         ...
         *             </ul>
         * @return the single {@link SpanStringUtil} instance
         */
        public SpanStringUtil setFlag(final int flag) {
            this.flag = flag;
            return this;
        }
         ...
         * @return the single {@link SpanStringUtil} instance
         */
        public SpanStringUtil setForegroundColor(@ColorInt final int color) {
         ...
         * @return the single {@link SpanStringUtil} instance
         */
        public SpanStringUtil setBackgroundColor(@ColorInt final int color) {
         ...
         * @return the single {@link SpanStringUtil} instance
         */
        public SpanStringUtil setQuoteColor(@ColorInt final int color) {
         ...
         * @return the single {@link SpanStringUtil} instance
         */
        public SpanStringUtil setLeadingMargin(@IntRange(from = 0) final int first,
         ...
         * @return the single {@link SpanStringUtil} instance
         */
        public SpanStringUtil setBullet(@IntRange(from = 0) final int gapWidth) {
         ...
         * @return the single {@link SpanStringUtil} instance
         */
        public SpanStringUtil setBullet(@ColorInt final int color,
         ...
         * @return the single {@link SpanStringUtil} instance
         */
        public SpanStringUtil setFontSize(@IntRange(from = 0) final int size) {
         ...
         * @return the single {@link SpanStringUtil} instance
         */
        public SpanStringUtil setFontSize(@IntRange(from = 0) final int size, final boolean isSp) {
            this.fontSize = size;
         ...
         * @return the single {@link SpanStringUtil} instance
         */
        public SpanStringUtil setFontProportion(final float proportion) {
         ...
         * @return the single {@link SpanStringUtil} instance
         */
        public SpanStringUtil setFontXProportion(final float proportion) {
         ...
         * @return the single {@link SpanStringUtil} instance
         */
        public SpanStringUtil setStrikethrough() {
         ...
         * @return the single {@link SpanStringUtil} instance
         */
        public SpanStringUtil setUnderline() {
         ...
         * @return the single {@link SpanStringUtil} instance
         */
        public SpanStringUtil setSuperscript() {
         ...
         * @return the single {@link SpanStringUtil} instance
         */
        public SpanStringUtil setSubscript() {
         ...
         * @return the single {@link SpanStringUtil} instance
         */
        public SpanStringUtil setItalic() {
            isItalic = true;
            return this;
        }
         ...
         * @return the single {@link SpanStringUtil} instance
         */
        public SpanStringUtil setBoldItalic() {
            isBoldItalic = true;
            return this;
        }
         ...
         * @return the single {@link SpanStringUtil} instance
         */
        public SpanStringUtil setFontFamily(@NonNull final String fontFamily) {
         ...
         * @return the single {@link SpanStringUtil} instance
         */
        public SpanStringUtil setTypeface(@NonNull final Typeface typeface) {
         ...
         * @return the single {@link SpanStringUtil} instance
         */
        public SpanStringUtil setClickSpan(@NonNull final ClickableSpan clickSpan) {
         ...
         * @return the single {@link SpanStringUtil} instance
         */
        public SpanStringUtil setUrl(@NonNull final String url) {
            this.url = url;
            return this;
        }
         ...
         * @return the single {@link SpanStringUtil} instance
         */
        public SpanStringUtil setShader(@NonNull final Shader shader) {
            this.shader = shader;
            return this;
        }
         ...
         * @return the single {@link SpanStringUtil} instance
         */
        public SpanStringUtil setShadow(@FloatRange(from = 0, fromInclusive = false) final float radius,
                                   final float dx,
                                   final float dy,
         ...
         * @return the single {@link SpanStringUtil} instance
         */
        public SpanStringUtil setSpans(@NonNull final Object... spans) {
            if (spans.length > 0) {
                this.spans = spans;
            }
            return this;
         ...
         * @return the single {@link SpanStringUtil} instance
         */
        public SpanStringUtil append(@NonNull final CharSequence text) {
         ...
         * @return the single {@link SpanStringUtil} instance
         */
        public SpanStringUtil appendSpace(@IntRange(from = 0) final int size) {
         ...
         * @return the single {@link SpanStringUtil} instance
         */
        public SpanStringUtil appendSpace(@IntRange(from = 0) final int size, @ColorInt final int color) {
            apply(mTypeSpace);
            spaceSize = size;
            spaceColor = color;
            return this;
...
//            LogAppUtil.d("rectHeight: " + rect.height(),
